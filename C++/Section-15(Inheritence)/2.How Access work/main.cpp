...
class Derived1: public Base{
    ...
    //c is private in base class so it does not inherits
    public:
...
class Derived4: private Derived2
{
    public:
    /*Since in derived2 class all members a,b becomes private so they won't inherit for derived4 class
    hence they are not accessible 
    */
