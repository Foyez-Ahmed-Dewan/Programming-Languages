...
void test7(){
    ...
    vector<int>:: iterator it = vec.begin();
    cout<< *it <<endl;  //1
    //advance increment the position of iterator to current_pos+=2
    advance(it,2);      //3
    cout<< *it <<endl;
    //next increment the position of  iterator to cur_pos+=2
    it = next(it,2);    //5
    cout<< *it <<endl;
    //prev decrement the position of iterator to cur_pos-=3
    it = prev(it,3);       //2
    cout<< *it <<endl;
